...
unsigned char* SHA_256(unsigned char* input, size_t file_size)
{
    ...
    uint8_t* message_8bit = pre_processing((uint8_t*)input, file_size);
    unsigned int length = align_length(file_size) / 4;
